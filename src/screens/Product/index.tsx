...
export function Product(){
    ...
    async function handleAdd() {
        ...
        .then(() => { navigation.navigate('home'); Alert.alert('Cadastro', 'Pizza cadastrada com sucesso.'); })
        .catch(() => {
            setIsLoading(false);
    ...
    function handleDelete() {
        ...
        .then(() => {
            ...
            .ref(photoPath)
            .delete()
            .then(() => { navigation.navigate('home'); Alert.alert('Delete', 'Pizza deletada com sucesso.'); });
        });
    }
